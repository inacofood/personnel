...
class PresensiExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize
{
    ...
    public function __construct($startDate = null, $endDate = null, $name = null , $dept = null)
    {
    ...
    public function collection()
    {
        ...
        $query = DB::table('employee_presensi_bulanan')
            ...
            if ($this->dept !== ['All']) {
                $query->whereIn('dept', $this->dept);
            }


        return $query
            ->groupBy('nik', 'nama' , 'dept', 'grade', DB::raw('MONTH(tanggal)'), DB::raw('YEAR(tanggal)'))
            ->get();
    ...
    {
        return [
            'NIK', 'Nama' , 'Departemen', 'Grade', 'Bulan', 'Tahun', 'Total Hadir' , 'Total Absent', 'Total Telat', 'Total Pulang Awal', 'Total Ketidakhadiran',
